scaterplotReg<-function (p1, p2, BREAKS, Xmin, Xmax, Ymin, Ymax, XLAB, YLAB) 
{
  ...
  plot(0, 0, type = "n", xlim = c(0, 60), ylim = c(0, 7), xaxt = "n", 
       yaxt = "n", xlab = "", ylab = "")
  text(10, 6, labels = "B0 =", cex = 1.3)
  text(29, 6, labels = sprintf("%.2f", regresion$coefficients[1]), 
       cex = 1.3)
  text(10, 5, labels = "B1 =", cex = 1.3)
  text(29, 5, labels = sprintf("%.2f", regresion$coefficients[2]), 
       cex = 1.3)
  text(25, 4, labels = "Pearson corr=", cex = 1.3)
  text(55, 4, labels = round(Corr, 3), cex = 1.3)
  text(10, 3, labels = "R2 =", cex = 1.3)
  text(25, 3, labels = round(Rcua, 3), cex = 1.3)
